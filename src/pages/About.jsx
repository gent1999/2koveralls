    ...
    <div className="min-h-screen bg-ink">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="border border-ink-line bg-ink-soft p-8 md:p-12">
          <h1 className="text-4xl font-bold mb-6 text-brand">About 2koveralls</h1>

          <div className="space-y-4 text-bone-dim leading-relaxed">
            <p>
            ...
            <h2 className="text-2xl font-bold mt-8 mb-4 text-bone">What We Offer</h2>

            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-bold text-brand mb-2">Trends</h3>
                <p>
              ...
              <div>
                <h3 className="text-lg font-bold text-brand mb-2">2K Overalls</h3>
                <p>
              ...
              <div>
                <h3 className="text-lg font-bold text-brand mb-2">Write Ups</h3>
                <p>
