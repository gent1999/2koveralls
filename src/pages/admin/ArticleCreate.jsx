        ...
        <form onSubmit={handleSubmit} className="space-y-6 border border-ink-line bg-ink-soft p-6">
          ...
          <div>
            ...
            <p className="mt-2 text-xs text-bone-dim">
              Appears on the /news list and in the homepage ticker. For full write-up articles, use{' '}
              <button type="button" onClick={() => navigate('/admin/writeups/create')} className="text-brand hover:text-bone underline">
                New Article
              </button> instead.
            </p>
          </div>
